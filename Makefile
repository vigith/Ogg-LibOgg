# This Makefile is for the Ogg::LibOgg extension to perl.
#
...
#     NAME => q[Ogg::LibOgg]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Ogg/LibOgg.pm]
...
TO_INST_PM = lib/Ogg/LibOgg.pm

PM_TO_BLIB = lib/Ogg/LibOgg.pm \
	blib/lib/Ogg/LibOgg.pm
...
# Ogg::LibOgg might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Ogg/LibOgg.pm $(INST_MAN3DIR)/Ogg::LibOgg.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Ogg/LibOgg.pm blib/lib/Ogg/LibOgg.pm 
